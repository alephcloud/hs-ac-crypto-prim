...
--
-- 2014-11-20 -- this is part of cryptonite <https://github.com/vincenthz/cryptonite>,
-- imported directly here, as cryptonite has not been released to hackage yet.
--
...
prfHMAC alg k = hmacIncr alg (MAC.hmacInit k)
  where hmacIncr :: HashAlgorithm a => a -> MAC.HMACContext a -> (ByteString -> ByteString)
        hmacIncr _ !ctx = \b -> toBytes $ MAC.hmacFinalize $ MAC.hmacUpdate ctx b
